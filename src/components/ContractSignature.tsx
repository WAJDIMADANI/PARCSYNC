...
export default function ContractSignature() {
  ...
  const handleCertificatUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      alert('Erreur lors de l\'upload de la visite médicale obligatoire');
    } finally {
      setUploading(false);
    }
  };
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8 max-w-2xl w-full text-center">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            ...
            <div className="text-left space-y-2 text-green-800">
              ...
              {certificatUploaded && <p>✓ Visite médicale obligatoire uploadée</p>}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">
                      Télécharger la visite médicale obligatoire
                    </h3>
                    <p className="text-gray-700 text-sm mb-4">
                      Veuillez uploader votre visite médicale obligatoire (médecin agréé préfecture) d'aptitude au travail. Ce document est obligatoire pour finaliser votre contrat.
                    </p>
                    {certificatUploaded ? (
                      <div className="flex items-center gap-2 text-green-700 font-medium">
                        <CheckCircle className="w-5 h-5" />
                        Visite médicale obligatoire uploadée
                      </div>
                    ) : (
