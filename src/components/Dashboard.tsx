  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white/80 backdrop-blur-xl border-b border-slate-200 px-3 py-1.5 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                onClick={() => signOut()}
                className="flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 text-white rounded-md transition-all duration-200 shadow-soft hover:shadow-glow font-medium text-xs"
              >
        ...
        <main className="flex-1 overflow-y-auto p-3 pb-2">
