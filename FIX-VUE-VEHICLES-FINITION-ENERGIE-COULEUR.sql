...
-- ============================================================
-- PROBLÈME: Les colonnes finition, energie, couleur ne sont pas
--           exposées dans la vue v_vehicles_list_ui
-- IMPACT: Le modal "Voir" et "Modifier" affichent ces champs vides
--         même quand ils sont renseignés dans la table vehicule
-- ============================================================
...
SELECT
  ...
  v.reste_a_payer_ttc,        -- ✅ AJOUTÉ (manquait aussi)
  v.financeur_nom,            -- ✅ AJOUTÉ (manquait aussi)
  v.financeur_adresse,        -- ✅ AJOUTÉ (manquait aussi)
  v.financeur_code_postal,    -- ✅ AJOUTÉ (manquait aussi)
  v.financeur_ville,          -- ✅ AJOUTÉ (manquait aussi)
  v.financeur_telephone,      -- ✅ AJOUTÉ (manquait aussi)
  v.photo_path,
  v.site_id,
  v.assurance_type,
...
-- Vérifier qu'un véhicule existant affiche bien ses données
SELECT
  immatriculation,
  marque,
  modele,
